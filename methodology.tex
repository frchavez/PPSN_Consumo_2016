...
obtain watts consumed by the algorithm by simply subtracting both values. In the \laptop the watts consumed vary continuously, so we record a video in order to 
