...
Blade		& Virtual Machine (on IBM 8CPUs x 2GHz Intel Xeon CPUE5504 @ 2.00GHz (x2), 16Gb RAM) & 4 & 4GB & \\
...
PowerTutor runs in the background and logs data on power utilization for each app, summarizing the info in an intuitive user interface.
