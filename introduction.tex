...
%  need of learning new parallel programming paradigms and
%  libraries. % don't see anything coming here - JJ  
% Just took off this paragraph. I didn't like it from the beginning,
% it's unrelated to the rest of the paper, and just does not set
% either the grounds or the theme for what's coming next. This next
% paragraph is perfectly fine for starting the paper. 

In the analysis of single or multi-processor algorithm performance, an
important feature 
is frequently forgotten: energy consumption, which largely correlates
...
accelerated pace, reducing energy consumption and taking it into
...
to problems associated to energy consumption in computing environments,
...
impact of energy consumption when running a well know EA, Genetic
