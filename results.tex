...
La Tabla~\ref{Table:result_todos} muestra los resultados obtenidos para un tamaño de población de 50, 100, 500 y 1000 individuos respectivamente. 
\begin{small}
...
\multicolumn{4}{c}{\textbf{Tamaño de población = 50}}\\ %\hline
...
\multicolumn{4}{c}{\textbf{Tamaño de población = 100}}\\ %\hline
...
\multicolumn{4}{c}{\textbf{Tamaño de población = 500}}\\ %\hline
...
\multicolumn{4}{c}{\textbf{Tamaño de población = 1000}}\\ %\hline
