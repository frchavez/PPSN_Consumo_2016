...
\begin{figure}[!t]
\subfloat[\label{fig:power}]{\hspace{1.2cm}\includegraphics[width=.48\textwidth]{excess_power_log_2.eps}}~~
...
\subfloat[\label{fig:powerlaw}]{\hspace{1.1cm}\includegraphics[width=.48\textwidth]{fitnessenergy.eps}}
