...
to yield analogous trade-offs between consumption and speed. 

In addition to absolute consumption values, it is also interesting to analyze
...
consumption as a function of the attained quality of solutions in devices in which
