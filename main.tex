...
\title{Energy aware Evolutionary Algorithms}

\author{F. Fernández de Vega \inst{1} \and F. Ch\'avez\inst{1} \and J. D\'iaz\inst{1} \and J.A. Garc\'ia\inst{1} \and P. Castillo\inst{2} \and Juan J. Merelo\inst{2}\\
\institute{ Universidad de Extremadura \\
\href{mailto:fcofdez@unex.es}{fcofdez@unex.es, mjdiaz@unex.es, jangelgm@unex.es, fchavez@unex.es} \\
